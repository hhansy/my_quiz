...
function displayResult(){
    ...
    result_field.innerHTML = `Ви дали ${points} правильних відповідей з ${total_question_count}.
    Точність: ${accuracy}`
    if (max_points && +max_points<points){
    document.cookie = `max-points=${points};max-age=${60*60*24*7*30}`
}
}
